...
public class User {
	...
	public User(int id, String phone, String username, String gender, String trueName, String recentlyLanded,
			List<Role> roles) {
		super();
		this.id = id;
		this.phone = phone;
    ...
    public User(int id,String phone, String username, String password, String gender, String trueName, String birthday, String personalBrief, String email, String recentlyLanded, String avatarImgUrl) {
        this.id = id;
    	this.phone = phone;
        this.username = username;
        this.password = password;
	...
	public User(String username, String trueName, String birthday,String gender, String email, String personalBrief) {
		super();
		this.username = username;
		this.gender = gender;
		this.trueName = trueName;
