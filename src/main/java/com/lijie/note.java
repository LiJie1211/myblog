...
public class note extends JFrame implements ActionListener,DocumentListener
{    //菜单
    ...
    {    final JDialog fontDialog=new JDialog(this,"字体设置",false);
        ...
        final JLabel sample=new JLabel("LiuZhaoPo的记事本");
    ...
    {    //新建
        ...
        {    editArea.requestFocus();
            JOptionPane.showMessageDialog(this,"对不起，此功能暂未实现。(扶我起来，我还要继续做主题！)","帮助主题",JOptionPane.INFORMATION_MESSAGE);
        }//帮助主题结束
        //关于
