...
! function() {
    var imgs = [
        '/img/games/NeverGiveUp/light.png',
        '/img/games/NeverGiveUp/btnselect2.png',
        '/img/games/NeverGiveUp/btnselect2.png',
        '/img/games/NeverGiveUp/btnselect2.png',
        '/img/games/NeverGiveUp/btnselect1.png',
        '/img/games/NeverGiveUp/btnselect.png',
        '/img/games/NeverGiveUp/bg.png',
        '/img/games/NeverGiveUp/machine.png',
        '/img/games/NeverGiveUp/machine_b.png',
        '/img/games/NeverGiveUp/wat.png',
        '/img/games/NeverGiveUp/star1.png',
        '/img/games/NeverGiveUp/star2.png',
        '/img/games/NeverGiveUp/spatter.png',
        '/img/games/NeverGiveUp/replay.png',
        '/img/games/NeverGiveUp/plates.png',
        '/img/games/NeverGiveUp/next.png',
        '/img/games/NeverGiveUp/dot.png',
        '/img/games/NeverGiveUp/dead.png',
        '/img/games/NeverGiveUp/btn1.png',
        '/img/games/NeverGiveUp/btn.png',
        '/img/games/NeverGiveUp/btn3.png',
        '/img/games/NeverGiveUp/menu.png',
        '/img/games/NeverGiveUp/terminal.png'
    ];
...
//背景音乐
// 图片
var arrImg = ['/img/games/NeverGiveUp/white.png', '/img/games/NeverGiveUp/red.png', '/img/games/NeverGiveUp/green.png', '/img/games/NeverGiveUp/blue.png']
        ...
        moving({
            ...
            callBack: function() {
                ...
                stars.timer = setInterval(function() {
                    var urls = ['/img/games/NeverGiveUp/star1.png', '/img/games/NeverGiveUp/star2.png'];
...
function mainFn() {
    ...
    function checkpoint(j) {
        ...
        j.character = j.character || '/img/games/NeverGiveUp/white.png';
        //人物选择
        switch (j.character) {
            case 'whiteC':
